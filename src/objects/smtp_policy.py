"""
SMTP Policy object implementation.

This module implements the SmtpPolicy class for handling Cisco Intersight
smtp policy in the GitOps workflow.
"""
...
class SmtpPolicy(BasePolicy):
    """
    Implementation for Intersight SMTP Policy objects.
    
    SMTP Policy defines settings and configurations for the smtp policy.
    """
    ...
    def folder_path(self) -> str:
        """Return the folder path for storing SMTP Policy YAML files."""
        return "policies/smtp"
    
    def _define_fields(self) -> Dict[str, FieldDefinition]:
        """Define the fields for SMTP Policy objects."""
