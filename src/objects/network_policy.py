"""
Network Configuration Policy object implementation.

This module implements the NetworkPolicy class for handling Cisco Intersight
network configuration policy in the GitOps workflow.
"""
...
class NetworkPolicy(BasePolicy):
    """
    Implementation for Intersight Network Configuration Policy objects.
    
    Network Configuration Policy defines settings and configurations for the network configuration policy.
    """
    
    @property
    def object_type(self) -> str:
        """Return the Intersight object type."""
        return "networkconfig.Policy"
    
    @property
    def display_name(self) -> str:
        """Return the human-readable display name."""
        return "Network Configuration Policy"
    
    @property
    def folder_path(self) -> str:
        """Return the folder path for storing Network Configuration Policy YAML files."""
        return "policies/network"
    
    def _define_fields(self) -> Dict[str, FieldDefinition]:
        """Define the fields for Network Configuration Policy objects."""
