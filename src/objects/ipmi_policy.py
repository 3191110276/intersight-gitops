"""
IPMI Over LAN Policy object implementation.

This module implements the IpmiPolicy class for handling Cisco Intersight
ipmi over lan policy in the GitOps workflow.
"""
...
class IpmiPolicy(BasePolicy):
    """
    Implementation for Intersight IPMI Over LAN Policy objects.
    
    IPMI Over LAN Policy defines settings and configurations for the ipmi over lan policy.
    """
    ...
    def display_name(self) -> str:
        ...
        return "IPMI Over LAN Policy"
    
    @property
    def folder_path(self) -> str:
        """Return the folder path for storing IPMI Over LAN Policy YAML files."""
        return "policies/ipmi"
    
    def _define_fields(self) -> Dict[str, FieldDefinition]:
        """Define the fields for IPMI Over LAN Policy objects."""
