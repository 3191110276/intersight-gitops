"""
SNMP Policy object implementation.

This module implements the SnmpPolicy class for handling Cisco Intersight
snmp policy in the GitOps workflow.
"""
...
class SnmpPolicy(BasePolicy):
    """
    Implementation for Intersight SNMP Policy objects.
    
    SNMP Policy defines settings and configurations for the snmp policy.
    """
    ...
    def folder_path(self) -> str:
        """Return the folder path for storing SNMP Policy YAML files."""
        return "policies/snmp"
    
    def _define_fields(self) -> Dict[str, FieldDefinition]:
        """Define the fields for SNMP Policy objects."""
