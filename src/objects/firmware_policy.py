"""
Firmware Policy object implementation.

This module implements the FirmwarePolicy class for handling Cisco Intersight
firmware policy in the GitOps workflow.
"""
...
class FirmwarePolicy(BasePolicy):
    """
    Implementation for Intersight Firmware Policy objects.
    
    Firmware Policy defines settings and configurations for the firmware policy.
    """
    ...
    def folder_path(self) -> str:
        """Return the folder path for storing Firmware Policy YAML files."""
        return "policies/firmware"
    
    def _define_fields(self) -> Dict[str, FieldDefinition]:
        """Define the fields for Firmware Policy objects."""
